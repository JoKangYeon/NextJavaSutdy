...
//
//     // 이미 추가된 상품인지 확인
//     if (myList.some(el => el.prodName === prodName)) {
//         alert("이미 추가된 상품입니다.");
...
//         // secondBox.style.marginBottom = "0px"
...
//         selectBox.style.width = "40px"
//         selectBox.style.height = "18px"
//         for (let j = 0; j < 10; j++) {
...
//         if(document.querySelector(`#${selectedList[i].prodName}`).checked){
//             // 숫자이외에 다 제거해주기
//             let price = parseInt(selectedList[i].prodPrice.replace(/[^0-9]/g, "").trim())
//             console.log(price)
//             totalPrice += price;
//         }
//     }
//     document.querySelector(".priceBox").textContent = 'Total Price: KRW ' + totalPrice;
// }
